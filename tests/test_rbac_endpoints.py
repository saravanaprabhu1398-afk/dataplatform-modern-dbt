...
class TestEditorPermissions:
    @pytest.mark.parametrize("method,path,body", [
        ...
        ("POST", "/deployments/validate", {"config_path": "pipelines/x.yaml"}),
        ("POST", "/deployments/deploy", {"config_path": "pipelines/x.yaml"}),
        ("POST", "/deployments/records/deploy-1/rollback", {"reason": "test"}),
        ("POST", "/deployment-connections", {"name": "Cluster", "target_id": "kubernetes"}),
        ("PATCH", "/deployment-connections/cluster-1", {"status": "connected"}),
        ("DELETE", "/deployment-connections/cluster-1", {}),
        ("POST", "/git/remotes", {"name": "repo", "remote_url": "/tmp/repo.git", "auth_type": "none"}),
        ("PUT", "/git/remotes/repo-1/workspace/file?path=README.md", {"content": "hello"}),
        ("POST", "/git/remotes/repo-1/workspace/pull", {}),
        ("POST", "/git/remotes/repo-1/workspace/commit", {"message": "update"}),
        ("POST", "/git/remotes/repo-1/workspace/push", {}),
